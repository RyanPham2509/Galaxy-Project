...
class MainWidget(RelativeLayout):
    ...
    from user_interaction import on_touch_down, on_touch_up, on_keyboard_down, on_keyboard_up, keyboard_closed
    ...
    H_NB_LINES = 10  # number of horizontal lines
    ...
    def init_audio(self):
        ...
        self.gameover_impact_sound = SoundLoader.load(
            "audio/gameover_impact.wav")
        self.gameover_voice_sound = SoundLoader.load(
        ...
        self.music2_sound = SoundLoader.load("audio/Calling(Spider_man).mp3")

        self.music1_sound.volume = 1
        self.galaxy_sound.volume = 0.25
        self.gameover_impact_sound.volume = 0.6
        self.gameover_voice_sound.volume = 0.25
    ...
    def generate_tiles_coordinates(self):
        last_x = 0
        last_y = 0
        # clean the old coordinates out of the screen
